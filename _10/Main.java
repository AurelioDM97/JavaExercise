...
public class Main {
    ...
    private static void exercise3() {
        ...
        if (isTestRetry == true || percentageOfTotal >= 70 && percentageOfTotal <= 80) {
            System.out.println("Grade: C");
        } else if (percentageOfTotal >= 90) {
            System.out.println("Grade: A");
        } else if (percentageOfTotal >= 80 && percentageOfTotal <= 90) {
            System.out.println("Grade: B");
        } else if (percentageOfTotal >= 60 && percentageOfTotal <= 70) {
